            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-medium text-black dark:text-white truncate">{project.project_title}</p>
                    <span
              ...
              <div className="grid grid-cols-4 gap-2">
                <div className="text-center p-2 rounded-lg bg-white/5">
                  ...
                  <p className="text-lg font-bold text-black dark:text-white">{project.total_views}</p>
                  <p className="text-[10px] text-muted-foreground">Views</p>
                </div>
                <div className="text-center p-2 rounded-lg bg-white/5">
                  <MousePointerClick size={14} className="mx-auto mb-1 text-green-400" />
                  <p className="text-lg font-bold text-black dark:text-white">{project.total_clicks}</p>
                  <p className="text-[10px] text-muted-foreground">Clicks</p>
                </div>
                <div className="text-center p-2 rounded-lg bg-white/5">
                  <TrendingUp size={14} className="mx-auto mb-1 text-cyan-400" />
                  <p className="text-lg font-bold text-black dark:text-white">{project.ctr.toFixed(1)}%</p>
                  <p className="text-[10px] text-muted-foreground">CTR</p>
                </div>
                <div className="text-center p-2 rounded-lg bg-white/5">
                  <Sparkles size={14} className="mx-auto mb-1 text-purple-400" />
                  <p className="text-lg font-bold text-black dark:text-white">{project.engagement_score.toFixed(0)}</p>
