                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-muted-foreground">#{section.engagement_rank}</span>
                      <span className="font-medium text-black dark:text-white capitalize">{section.section_id}</span>
                    </div>
                    <span
                  ...
                  {section.optimization_hint !== 'performing_well' && (
                    <p className="text-xs text-amber-400 mt-2 flex items-center gap-1">
                      <TrendingUp size={12} />
                      {section.optimization_hint.replace(/_/g, ' ')}
                    </p>
                  )}
                </motion.div>
              );
